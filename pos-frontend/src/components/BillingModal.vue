            ...
            <!-- <svg id="msi"></svg> -->
                    ...
                    <div class='row m-0'>
                            <div class='col-12 text-center mb-3 pt-0'>
                                <img src="@/assets/swat.png" class='img-fluid bill-img my-3' width="130" alt='' />
                                <p class='m-0 small billText'>22F4+JR6, Peelamedu</p>
                                <p class='m-0 small billText'>HUDCO Colony, Coimbatore, Tamil Nadu 641004</p>
                            ...
                            <div class='col-12 px-1 text-start'>
                                ...
                                <div v-if="cartProducts.length">
                                    <div class='row justify-content-between m-0' v-for="(data,index) in cartProducts" :key="index">
                                                <div class='col-6 px-0'>
                                                ...
                                                <div class='col-2 px-0 text-end'>
                                                    <p class='m-0 small billText'>₹ {{data.price * data.count }}</p>
                                                </div>
                                            </div>
                                </div>
                                <div v-else>
                                ...
                                <div class='row justify-content-between m-0'>
                                    <div class='col-6 px-0'>
                                        <p class='m-0 small billText'>Tax {{ tax }}% (VAT Included)</p>
                                    </div>
                                    <div class='col-3 px-0 text-end'>
                                ...
                                <div class='row justify-content-between m-0 mb-2'>
                                    <div class='col-6 px-0'>
                                    <p class='m-0 loyaltyPoints'>TOTAL ITEMS : {{ cartProducts.length }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class='col-12 px-1 text-start mb-3'>
                                <p class='m-0 small term'>TERMS &amp; CONDITIONS</p>
                                <p class='m-0 mt-1 small term'>1. Goods sold cannot be returned or exchanged after long time.</p>
                                <p class='m-0 small term'>2. Any Complaint on product, the return is eligible</p>
                            </div>
                            <div class='col-12 text-center my-2'>
                                <p class='m-0 small billText'>***** Thank You Visit Again *****</p>
                            </div>
                    </div>
                    </div>
              </div>
...
export default {
  ...
  computed : {
    ...
    getData(){
         ...
         return tempTime.getDate() + "-" + (tempTime.getMonth() + 1) + "-" + tempTime.getFullYear();
    },
    getTime(){
        const tempTime = new Date()
        return ((tempTime.getHours() === 0) ?
                    12 : 
